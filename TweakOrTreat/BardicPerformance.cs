...
namespace TweakOrTreat
{
    class BardicPerformance
    {
        ...
        static void addFastPerfromance(BlueprintArchetype archetype, BlueprintCharacterClass clazz, String replacement)
        {
            ...
            clazz.Progression.UIGroups = clazz.Progression.UIGroups.AddToArray(Helpers.CreateUIGroup(newMoveAction, newSwiftAction));
        }
        ...
        static internal void load()
        {
            ...
            addFastPerfromance(sensei, monk, "a sensei ");
            addFastPerfromance(evangelist, cleric, "an evangelist ");
        }
    }
}
